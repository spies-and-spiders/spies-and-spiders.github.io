		...
		super({
			...
			tableViewOptions: {
				...
				colTransforms: {
					...
					arm: {name: "Armour", transform: arm => arm != null ? Parser.defenceToFull(arm, {key: "arm"}) : ""},
					wil: {name: "Will", transform: wil => wil != null ? Parser.defenceToFull(wil, {key: "wil"}) : ""},
					ref: {name: "Reflex", transform: ref => ref != null ? Parser.defenceToFull(ref, {key: "ref"}) : ""},
					fort: {name: "Fortitude", transform: fort => fort != null ? Parser.defenceToFull(fort, {key: "fort"}) : ""},
